...
const menuItems = [
  {
    path: 'https://instagram.com/crefati.tech',
    label: 'Instagram @crefati.tech',
  },
  {
    path: 'https://facebook.com/crefatitech',
    label: 'Facebook @crefatitech',
  },
];
      ...
      <Container>
        <Flex sx={styles.footerInner}>
          <Flex sx={styles.copyright}>
            <Text as="span">
              &copy; Copyright by {new Date().getFullYear()} Crefati Technologies LTD
            </Text>
          </Flex>
