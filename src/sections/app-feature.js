...
import app from 'assets/images/dashboard.png';
...
const data = [
  ...
  {
    id: 5,
    label: 'Agency/Startup/App',
  },
  {
    id: 6,
    label: 'Blog/Magazine etc',
  },
];
        ...
        <Grid sx={styles.grid}>
          <Box sx={styles.rightContent}>
            <SectionHeading
              emoji={emoji}
              sx={styles.heading}
              title="Let's build your business website now"
              description="We believe purposeful design can
			  transform organizations/businesses/institutions, inspire actions and enable progress.
			  We are dedicated team of researchers, web design & development,
			  brand and content strategy professionals."
            />
