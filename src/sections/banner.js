...
import illustration from 'assets/images/roller.png';
      ...
      <Container>
        <Box sx={styles.contentWrapper}>
          <Box sx={styles.bannerContent}>
            <Heading as="h1">
              <b>Crefati</b>, We help businesses reach more customers around the world...
            </Heading>
            <Text as="p">
              Bring more trust and credibility to your business. 
			  Head start your competitors by building a WEBSITE for your business today.
            </Text>
            <Heading as="h4">
			Call: <b>069 369 0371</b> / Email: <b>biz@crefati.com</b>
			</Heading>
            <Flex sx={styles.sponsoredBy}>
              <Text as="span">Our tech:</Text>
