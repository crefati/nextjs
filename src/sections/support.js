...
import support from 'assets/images/flexible.png';
...
const data = [
  {
    ...
    description: `We develop innovative websites that are destined to grow. Send 
	us your business info via email biz@crefati.com to get started.`,
  },
  {
    id: 2,
    icon: support,
    title: 'Fast & Flexible Websites',
    description: `We analyze your business to design a website which increases conversion
	 rates and produces positive results. Call 069 369 0371`,
  },
];
